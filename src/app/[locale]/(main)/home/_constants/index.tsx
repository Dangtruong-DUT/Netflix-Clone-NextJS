...
export const APP_FEATURES: FeatureType[] = [
    {
...
export const FQA_LIST: FaqItem[] = [
    ...
    },
    {
        ...
        answer: 'Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from 74,000 ₫ to 186,000 ₫ a month. No extra costs, no contracts.'
    },
    {
